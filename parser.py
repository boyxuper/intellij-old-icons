...
_ICON_DIR_AUTO = '.auto'
#_INSTALL_DIR = r'E:\Program Files (x86)\JetBrains\PyCharm 2.7.2'
_INSTALL_DIR = r'E:\Program Files (x86)\JetBrains\PhpStorm 6.0.1'
# _INSTALL_DIR = r'/Applications/PyCharm.app'
